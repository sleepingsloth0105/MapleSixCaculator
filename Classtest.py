...
six.enhance_addname_and_level('잔시',0)
six.enhance_addname_and_level('퀴버',0)
six.enhance_addname_and_level('레인',0)
six.enhance_addname_and_level('미라주',0)
...
six.mastery_addname_and_level('폭시',1)
...
'''
six.skill_addname_and_level('오리진',1)
...
print (575/372 , check , check10)
'''
six1.skill_addname_and_level('오리진',3)
