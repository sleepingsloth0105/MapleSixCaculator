...
class Enhance: # 5차 강화 코어
    def __init__(self):
        ...
        self.solerda = [ 4,1,1,1,2,2,2,3,3,8,3,3,3,3,3,3,3,3,4,12,4,4,4,4,4,5,5,5,6,15,100]
...
class CharacterV2:
    ...
    def printresult(self):
        ...
        usedir = recentdir + "/스킬트리(솔 에르다).txt"
        usedir_detail = recentdir + "/스킬트리(솔 에르다)_세부내용.txt"
